...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        try:
            ...
            X_train_features_df = preprocess_train_df.drop(TARGET_COLUMN, axis=1)
            X_test_features_df = preprocess_test_df.drop(TARGET_COLUMN, axis=1)
            Y_train_df = preprocess_train_df[TARGET_COLUMN].astype('int64')
            Y_test_df = preprocess_test_df[TARGET_COLUMN].astype('int64')
